...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Intraday_Live_c152c641d2eb91543991_20210513093451_archive.zip';
	const ARCHIVE_SIZE		 = '851187462';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'c152c64-13093451';
    const SECONDARY_PACKAGE_HASH = 'f73e949-13093451';
	const VERSION			 = '1.4.0';

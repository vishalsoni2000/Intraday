		...
		<div class="room <?php if($counter == 0) { ?>room--current<?php }?>">
			...
			?>
				...
				<?php
					...
					{
						$image_id = starto_get_image_id($slide['slide_image'][0]['url']);
				...
				<?php
					...
					{
						$image_id = starto_get_image_id($slide['slide_image'][1]['url']);
			...
			?>
				...
				<?php
					...
					{
						$image_id = starto_get_image_id($slide['slide_image'][3]['url']);
				...
				<?php
					...
					{
						$image_id = starto_get_image_id($slide['slide_image'][4]['url']);
				...
				<div class="room-side room-side--left">
					...
					<?php
						...
						{
							$image_id = starto_get_image_id($slide['slide_image'][2]['url']);
			...
			?>
				...
				<div class="room-side room-side--right">
					<?php
						...
						{
							$image_id = starto_get_image_id($slide['slide_image'][5]['url']);
					...
					<?php
						...
						{
							$image_id = starto_get_image_id($slide['slide_image'][6]['url']);
					...
					<?php
						...
						{
							$image_id = starto_get_image_id($slide['slide_image'][7]['url']);

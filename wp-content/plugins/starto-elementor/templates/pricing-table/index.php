...
<div class="pricing-plan-switch-wrap">
	<span class="pricing-plan-switch-month"><?php echo __( 'Bill month', 'starto-elementor' ); ?></span>
	...
	<span class="pricing-plan-switch-year"><?php echo __( 'Bill yearly', 'starto-elementor' ); ?></span>
</div>
<?php
	}
?>
				...
				<div class="overflow-inner">
					<div class="pricing-plan-wrap">
						...
						<div class="pricing-plan-price-wrap">
							...
							<span class="pricing-plan-unit-month">/<?php echo __( 'Month', 'starto-elementor' ); ?></span>
							<span class="pricing-plan-unit-year hide">/<?php echo __( 'Year', 'starto-elementor' ); ?></span>
						</div>
					</div>
					...
					<div class="pricing-plan-content">
						<?php 
							...
							{
								$slide['slide_features'] = nl2br($slide['slide_features']);
								$feature_lists = explode('<br />', trim($slide['slide_features']));

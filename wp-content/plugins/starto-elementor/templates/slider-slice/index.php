	...
	?>
		<section class="slides-nav">
		    <nav class="slides-nav-nav">
		      	<button class="slides-nav__prev js-prev"><?php esc_html_e( 'Prev' , 'starto-elementor' ); ?></button>
			  	<button class="slides-nav__next js-next"><?php esc_html_e( 'Next' , 'starto-elementor' ); ?></button>
		    </nav>
	  	</section>
	<?php
		}

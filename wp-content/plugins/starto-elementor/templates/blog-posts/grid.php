		    ...
		    <div class="post-featured-image static">
			    ...
			    <div class="post-featured-image-hover <?php if(!empty($tg_enable_lazy_loading)) { ?>lazy<?php } ?>">
					...
					?>
			     	...
			     	<?php 
				     	$blog_featured_img_url = get_the_post_thumbnail_url($post_ID, 'starto-blog'); 
				     	$blog_featured_img_data = wp_get_attachment_image_src(get_post_thumbnail_id($post_ID), "starto-blog" );
				     	...
				     	{
				     ?>
				     <img <?php echo starto_get_blank_img_attr(); ?> <?php echo esc_attr($return_attr['source']); ?>="<?php echo esc_url($blog_featured_img_url); ?>" class="<?php echo esc_attr($return_attr['class']); ?> <?php echo esc_attr($animation_class); ?>" alt="<?php echo esc_attr($blog_featured_img_alt); ?>"/>
				     <?php
					     }
					?>

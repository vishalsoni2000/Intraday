<?php
	...
	if(!empty($slides))
	{
		...
		$thumb_image_name = 'starto-gallery-list';
?>
...
?>
		<div class="distortion-grid-item distortion-grid-item--bg theme-<?php echo esc_attr($theme_code); ?>">
			<div class="distortion-grid-item-img" data-displacement="<?php echo plugins_url( '/starto-elementor/assets/images/distortion-grid/' ); ?><?php echo esc_attr($displacement); ?>" data-intensity="<?php echo esc_attr($intensity); ?>" <?php echo $speed_in; ?> <?php echo $speed_out; ?> <?php echo $additional_attr; ?>>

			...
			<div class="card-info">
				...
				<div class="tooltip-templates">
				    <div id="tooltip_content_<?php echo esc_attr($post_ID); ?>" class="course-tooltip-content">
					    <h5><?php esc_html_e("What you'll learn", 'starto-elementor' ); ?></h5>
				...
				?>
					...
					<div class="card-rating-total">
						...
						<?php
							if($total > 1)
							{
								echo esc_html_e('ratings', 'starto-elementor' );
							}
							else
							{
								echo esc_html_e('rating', 'starto-elementor' );	
							}
						?>)
					</div>
		    	<?php
				...
				<?php
					...
					{
				?>
				<div class="card-excerpt"><?php echo starto_limit_get_excerpt(strip_tags(get_the_excerpt()), $settings['excerpt_length']['size'], '...'); ?></div>
				<?php
					}
				?>
				...
				<?php
					$meta_class = '';
					if(function_exists('starto_get_course_curriculum_number') OR $settings['show_lesson'] != 'yes' OR $settings['show_student'] != 'yes')	
					{
						$meta_class = 'empty';
					}
				?>
				<div class="card-meta-wrapper <?php echo esc_attr($meta_class); ?>">
					<?php
					if(function_exists('starto_get_course_curriculum_number') && $settings['show_lesson'] == 'yes')
					{
					...
					<div class="card-meta">
						...
						<span class="card__lesson">
							...
							<?php
								if($course_lessons > 1)
								{
									echo esc_html_e('lessons', 'starto-elementor' );
								}
								else
								{
									echo esc_html_e('lesson', 'starto-elementor' );
								}
							?>
						</span>
					</div>
					...
					<div class="card-meta">
						...
						<span class="card__student">
							...
							<?php
								...
								{
									echo esc_html_e('students', 'starto-elementor' );
								}
								else
								{
									echo esc_html_e('student', 'starto-elementor' );
								}
							?>
						</span>
					</div>
...
<?php
	if($settings['show_pagination'] == 'yes')
	{
		...
		if($wp_query->max_num_pages > 1)
	    {
	    	...
	    	{
	    	    starto_pagination($wp_query->max_num_pages, 4, 'course-posts-grid' );
	    	}
	    	else
	    	{
?>
...
?>
			<div class="pagination-detail">
		    	<?php esc_html_e('Page', 'starto-elementor' ); ?> <?php echo esc_html($paged); ?> <?php esc_html_e('of', 'starto-elementor' ); ?> <?php echo esc_html($wp_query->max_num_pages); ?>
		    </div>
<?php
	    }
	}

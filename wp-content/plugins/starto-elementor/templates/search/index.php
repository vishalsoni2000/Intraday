...
?>
<div class="starto-search-icon"><a data-open="tg_search_<?php echo esc_attr($widget_id); ?>" href="javascript:;"><?php \Elementor\Icons_Manager::render_icon( $settings['icon'], [ 'aria-hidden' => 'true' ] ); ?></a></div>

<div id="tg_search_<?php echo esc_attr($widget_id); ?>" class="starto-search-wrapper">

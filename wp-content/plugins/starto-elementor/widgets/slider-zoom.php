 ...
 * @since 1.0.0
 */
class Starto_Slider_Zoom extends Widget_Base {
	...
	public function get_title() {
		return __( 'Zoom Slider', 'starto-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Background', 'starto-elementor' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
		    'overlay_background',
		    [
		        'label' => __( 'Overlay Background', 'starto-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#0000000',
		        'selectors' => [
	...
	protected function render() {
		include(STARTO_ELEMENTOR_PATH.'templates/slider-zoom/index.php');
	}

 ...
 * @since 1.0.0
 */
class Starto_Navigation_Menu extends Widget_Base {
	...
	public function get_title() {
		return __( 'Theme Navigation Menu', 'starto-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_parent_menu',
			[
				'label' => __( 'Parent Menu', 'starto-elementor' ),
			]
		);
		...
		$this->add_control(
			'nav_menu',
			[
				'label' => __( 'Navigation Menu', 'starto-elementor' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Hover Style', 'starto-elementor' ),
		...
		$this->start_controls_section(
			'section_sub_menu',
			[
				'label' => __( 'Sub Menu', 'starto-elementor' ),
			]
		);
		...
		$this->add_control(
			'nav_sub_menu_margin',
			[
				'label' => __( 'Padding', 'starto-elementor' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px' ],
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Box Shadow', 'starto-elementor' ),
		...
		$this->start_controls_section(
			'section_menu_style',
			array(
				'label'      => esc_html__( 'Parent Menu Colors', 'starto-elementor' ),
		...
		$this->add_control(
		    'nav_menu_font_color',
		    [
		        'label' => __( 'Font Color', 'starto-elementor' ),
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Hover Font Color', 'starto-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#0055FF',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Hover Border Color', 'starto-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#0055FF',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Active Font Color', 'starto-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#0055FF',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Active Border Color', 'starto-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#0055FF',
		        'selectors' => [
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Sub Menu Colors', 'starto-elementor' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
	...
	protected function render() {
		include(STARTO_ELEMENTOR_PATH.'templates/navigation-menu/index.php');
	}

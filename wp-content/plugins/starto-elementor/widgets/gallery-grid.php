 ...
 * @since 1.0.0
 */
class Starto_Gallery_Grid extends Widget_Base {
	...
	public function get_title() {
		return __( 'Grid Gallery', 'starto-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .starto-gallery-grid-content-wrapper div.gallery-grid-item' => 'border-radius: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		include(STARTO_ELEMENTOR_PATH.'templates/gallery-grid/index.php');
	}

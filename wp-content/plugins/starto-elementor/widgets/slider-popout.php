 ...
 * @since 1.0.0
 */
class Starto_Slider_Popout extends Widget_Base {
	...
	public function get_title() {
		return __( 'Fullscreen Popout Slider', 'starto-elementor' );
	}
	...
	protected function render() {
		include(STARTO_ELEMENTOR_PATH.'templates/slider-popout/index.php');
	}

 ...
 * @since 1.0.0
 */
class Starto_Mouse_Drive_Vertical_Carousel extends Widget_Base {
	...
	public function get_name() {
		return 'starto-mouse-driven-vertical-carousel';
	}
	...
	public function get_title() {
		return __( 'Mouse Driven Vertical Carousel', 'starto-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
		    'header',
		    [
		        'label' => __( 'Header', 'starto-elementor' ),
		...
		$this->add_control(
		    'sub_header',
		    [
		        'label' => __( 'Sub Header', 'starto-elementor' ),
		        'type' => Controls_Manager::TEXT,
		    ]
		);
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Header & Sub Header', 'starto-elementor' ),
		...
		$this->add_control(
		    'header_color',
		    [
		        'label' => __( 'Header Color', 'starto-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Header Typography', 'starto-elementor' ),
		...
		$this->add_control(
		    'sub_header_color',
		    [
		        'label' => __( 'Sub Header Color', 'starto-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Sub Header Typography', 'starto-elementor' ),
	...
	protected function render() {
		include(STARTO_ELEMENTOR_PATH.'templates/mouse-driven-vertical-carousel/index.php');
	}

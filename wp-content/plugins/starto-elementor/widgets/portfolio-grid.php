 ...
 * @since 1.0.0
 */
class Starto_Portfolio_Grid extends Widget_Base {
	...
	public function get_title() {
		return __( 'Portfolio Grid', 'starto-elementor' );
	}
	...
	protected function render() {
		include(STARTO_ELEMENTOR_PATH.'templates/portfolio-grid/index.php');
	}

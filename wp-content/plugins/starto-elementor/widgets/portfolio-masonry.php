 ...
 * @since 1.0.0
 */
class Starto_Portfolio_Masonry extends Widget_Base {
	...
	public function get_name() {
		return 'starto-portfolio-masonry';
	}
	...
	public function get_title() {
		return __( 'Portfolio Masonry', 'starto-elementor' );
	}
	...
	protected function render() {
		include(STARTO_ELEMENTOR_PATH.'templates/portfolio-masonry/index.php');
	}

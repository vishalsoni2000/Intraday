 ...
 * @since 1.0.0
 */
class Starto_Slider_Room extends Widget_Base {
	...
	public function get_title() {
		return __( 'Fullscreen 3D Room Slider', 'starto-elementor' );
	}
		...
		$this->add_control(
			...
			[
				...
				'fields' => [
					[
						'name' => 'slide_image',
						'label' => __( 'Image (max. 8)', 'starto-elementor' ),
	...
	protected function render() {
		include(STARTO_ELEMENTOR_PATH.'templates/slider-room/index.php');
	}

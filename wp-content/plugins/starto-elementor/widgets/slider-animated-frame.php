 ...
 * @since 1.0.0
 */
class Starto_Slider_Animated_Frame extends Widget_Base {
	...
	public function get_name() {
		return 'starto-slider-animated-frame';
	}
	...
	public function get_title() {
		return __( 'Animated Frame Slider', 'starto-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'imagesloaded', 'anime', 'starto-elementor' ];
	}
	...
	protected function render() {
		include(STARTO_ELEMENTOR_PATH.'templates/slider-animated-frame/index.php');
	}

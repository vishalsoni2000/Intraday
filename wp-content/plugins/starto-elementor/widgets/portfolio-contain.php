 ...
 * @since 1.0.0
 */
class Starto_Portfolio_Contain extends Widget_Base {
	...
	public function get_name() {
		return 'starto-portfolio-contain';
	}
	...
	public function get_title() {
		return __( 'Portfolio Contain', 'starto-elementor' );
	}
	...
	protected function render() {
		include(STARTO_ELEMENTOR_PATH.'templates/portfolio-contain/index.php');
	}

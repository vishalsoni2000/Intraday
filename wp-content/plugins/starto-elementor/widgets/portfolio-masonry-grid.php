 ...
 * @since 1.0.0
 */
class Starto_Portfolio_Masonry_Grid extends Widget_Base {
	...
	public function get_name() {
		return 'starto-portfolio-masonry-grid';
	}
	...
	public function get_title() {
		return __( 'Portfolio Masonry Grid', 'starto-elementor' );
	}
	...
	protected function render() {
		include(STARTO_ELEMENTOR_PATH.'templates/portfolio-masonry-grid/index.php');
	}

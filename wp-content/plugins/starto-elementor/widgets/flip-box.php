 ...
 * @since 1.0.0
 */
class Starto_Flip_Box extends Widget_Base {
	...
	public function get_title() {
		return __( 'Flip Box', 'starto-elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
		    'default_image',
		    [
		        'label' => __( 'Default Background Image', 'starto-elementor' ),
		...
		$this->add_control(
		    'default_icon',
		    [
		        'label' => __( 'Default Icon', 'starto-elementor' ),
		        'type' => Controls_Manager::MEDIA,
		    ]
		);
		...
		$this->add_responsive_control(
		    'icon_max_width',
		    [
		        'label' => __( 'Icon Max Width (in px)', 'starto-elementor' ),
		...
		$this->add_control(
		    'default_title',
		    [
		        'label' => __( 'Default Title', 'starto-elementor' ),
		...
		$this->add_control(
		    'default_description',
		    [
		        'label' => __( 'Default Description', 'starto-elementor' ),
		...
		$this->add_control(
		    'flip_image',
		    [
		        'label' => __( 'Flip Background Image', 'starto-elementor' ),
		        'type' => Controls_Manager::MEDIA,
		    ]
		);
		...
		$this->add_control(
		    'flip_title',
		    [
		        'label' => __( 'Flip Title', 'starto-elementor' ),
		        'type' => Controls_Manager::TEXT,
		    ]
		);
		...
		$this->add_control(
		    'flip_button_title',
		    [
		        'label' => __( 'Flip Button Title', 'starto-elementor' ),
		        'type' => Controls_Manager::TEXT,
		    ]
		);
		...
		$this->add_control(
		    'flip_button_link',
		    [
		        'label' => __( 'Flip Button Link', 'starto-elementor' ),
		...
		$this->add_control(
		    'content_bg_color',
		    [
		        'label' => __( 'Overlay Background Color', 'starto-elementor' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Default Content', 'starto-elementor' ),
		...
		$this->add_control(
		    'default_title_color',
		    [
		        'label' => __( 'Default Title Color', 'starto-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Default Title Typography', 'starto-elementor' ),
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Default Description Color', 'starto-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Default Description Typography', 'starto-elementor' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Flip Content', 'starto-elementor' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
		    'flip_title_color',
		    [
		        'label' => __( 'Flip Title Color', 'starto-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Flip Title Typography', 'starto-elementor' ),
		...
		$this->add_control(
		    'button_bg_color',
		    [
		        'label' => __( 'Flip Button Background Color', 'starto-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#3d64ff',
		        'selectors' => [
		...
		$this->add_control(
		    'button_font_color',
		    [
		        'label' => __( 'Flip Button Font Color', 'starto-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Flip Button Hover Background Color', 'starto-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#ffffff',
		        'selectors' => [
		...
		$this->add_control(
		    ...
		    [
		        'label' => __( 'Flip Button Hover Font Color', 'starto-elementor' ),
		        'type' => Controls_Manager::COLOR,
		        'default' => '#222222',
		        'selectors' => [
	...
	protected function render() {
		include(STARTO_ELEMENTOR_PATH.'templates/flip-box/index.php');
	}

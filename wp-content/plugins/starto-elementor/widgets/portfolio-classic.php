 ...
 * @since 1.0.0
 */
class Starto_Portfolio_Classic extends Widget_Base {
	...
	public function get_name() {
		return 'starto-portfolio-classic';
	}
	...
	public function get_title() {
		return __( 'Portfolio Classic', 'starto-elementor' );
	}
	...
	protected function render() {
		include(STARTO_ELEMENTOR_PATH.'templates/portfolio-classic/index.php');
	}

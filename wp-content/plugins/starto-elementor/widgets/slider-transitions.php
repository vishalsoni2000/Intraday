 ...
 * @since 1.0.0
 */
class Starto_Slider_Transitions extends Widget_Base {
	...
	public function get_name() {
		return 'starto-slider-transitions';
	}
	...
	public function get_title() {
		return __( 'Fullscreen Transitions Slider', 'starto-elementor' );
	}
			...
			[
				...
				'fields' => [
					[
						...
						'label' => __( 'Image Left', 'starto-elementor' ),
						'type' => Controls_Manager::MEDIA,
						'label_block' => true,
					],
					[
						'name' => 'slide_image_right',
						'label' => __( 'Image Right', 'starto-elementor' ),
						'type' => Controls_Manager::MEDIA,
						'label_block' => true,
					],
					[
	...
	protected function render() {
		include(STARTO_ELEMENTOR_PATH.'templates/slider-transitions/index.php');
	}

 ...
 * @since 1.0.0
 */
class Starto_Gallery_Masonry extends Widget_Base {
	...
	public function get_title() {
		return __( 'Masonry Gallery', 'starto-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'tilt', 'masonry', 'starto-elementor' ];
	}
	...
	protected function render() {
		include(STARTO_ELEMENTOR_PATH.'templates/gallery-masonry/index.php');
	}

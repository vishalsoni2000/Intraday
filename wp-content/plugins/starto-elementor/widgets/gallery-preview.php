 ...
 * @since 1.0.0
 */
class Starto_Gallery_Preview extends Widget_Base {
	...
	public function get_title() {
		return __( 'Fullscreen Gallery Preview', 'starto-elementor' );
	}
	...
	public function get_script_depends() {
		return [ 'slick', 'tweenmax', 'starto-elementor' ];
	}
	...
	protected function render() {
		include(STARTO_ELEMENTOR_PATH.'templates/gallery-preview/index.php');
	}

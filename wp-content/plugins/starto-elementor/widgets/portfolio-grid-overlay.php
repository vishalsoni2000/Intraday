 ...
 * @since 1.0.0
 */
class Starto_Portfolio_Grid_overlay extends Widget_Base {
	...
	public function get_name() {
		return 'starto-portfolio-grid-overlay';
	}
	...
	public function get_title() {
		return __( 'Portfolio Grid Overlay', 'starto-elementor' );
	}
	...
	protected function render() {
		include(STARTO_ELEMENTOR_PATH.'templates/portfolio-grid-overlay/index.php');
	}

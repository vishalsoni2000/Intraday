...
final class Kirki_Fonts {
	...
	public static function get_standard_fonts() {
		...
		//Add custom fonts
		$custom_fonts = get_theme_mod( 'starto_custom_fonts' );
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'starto' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'starto' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'starto' ),
			'200'       => esc_attr__( 'Light 200', 'starto' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'starto' ),
			'300'       => esc_attr__( 'Book 300', 'starto' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'starto' ),
			'400'       => esc_attr__( 'Normal 400', 'starto' ),
			'regular'   => esc_attr__( 'Normal 400', 'starto' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'starto' ),
			'500'       => esc_attr__( 'Medium 500', 'starto' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'starto' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'starto' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'starto' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'starto' ),
			'700'       => esc_attr__( 'Bold 700', 'starto' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'starto' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'starto' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'starto' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'starto' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'starto' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'starto' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'starto' ),
		);
	}

...
class Kirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'kirkiL10n',
			array(
				'noFileSelected' => esc_attr__( 'No File Selected', 'starto' ),
				'remove'         => esc_attr__( 'Remove', 'starto' ),
				'default'        => esc_attr__( 'Default', 'starto' ),
				'selectFile'     => esc_attr__( 'Select File', 'starto' ),
				'standardFonts'  => esc_attr__( 'Standard Fonts', 'starto' ),
				'googleFonts'    => esc_attr__( 'Google Fonts', 'starto' ),
			)
		);

...
starto_set_page_content_class('blog-wrapper');
...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post-wrapper">
		...
		<?php
		    ...
		    {
		     $small_image_url = wp_get_attachment_image_src($image_id, 'starto-blog', true);
		?>
		    <div class="post-featured-image static">
			    <div class="post-featured-image-hover">
					...
					?>
			     	...
			     	<?php the_post_thumbnail('starto-blog', array('class' => 'smoove')); ?>
			     	<?php echo starto_get_post_format_icon(get_the_ID()); ?>
			    ...
			    <div class="post-button-wrapper">
					...
					<div class="post-author">
					    ...
					    <div class="post-author-detail">
					     	<span class="post-author-name-before"><?php esc_html_e('by', 'starto' ); ?></span>&nbsp;<span class="post-author-name"><?php echo esc_html($author_name); ?></span>
					    </div>
					    <br class="clear"/>
					</div>
					<?php
				    ...
				    <?php
						...
						{
					?>
					<a class="continue-reading" href="<?php echo esc_url(get_permalink()); ?>" title="<?php the_title_attribute(); ?>"><?php esc_html_e('Continue Reading', 'starto' ); ?><span></span></a>
					<?php
						}
					?>
			    </div><br class="clear"/>

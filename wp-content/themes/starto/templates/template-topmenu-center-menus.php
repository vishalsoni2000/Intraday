    ...
    <div class="standard-wrapper">
    		...
    		<div class="logo-alignment">
	    	    <a id="custom_logo" class="logo-wrapper <?php if(!empty($page_menu_transparent)) { ?>hidden<?php } else { ?>default<?php } ?>" href="<?php echo esc_url(home_url('/')); ?>">
					...
					<?php
						...
						{
					?>
	    	    	<img src="<?php echo esc_url($starto_retina_logo); ?>" alt="<?php esc_attr(get_bloginfo('name')); ?>" width="118" height ="36"/>
	    	    	<?php 
		    	    	}
		    	    ?>
	    	    </a>
    		...
    		<div class="logo-alignment">
	    	    <a id="custom_logo_transparent" class="logo-wrapper <?php if(empty($page_menu_transparent)) { ?>hidden<?php } else { ?>default<?php } ?>" href="<?php echo esc_url(home_url('/')); ?>">
					...
					<?php
						...
						{
					?>
	    	    	<img src="<?php echo esc_url($starto_retina_transparent_logo); ?>" alt="<?php esc_attr(get_bloginfo('name')); ?>" width="118" height ="36"/>
	    	    	<?php 
		    	    	}
		    	    ?>
	    	    </a>
        ...
        <div id="menu-wrapper">
			...
			<?php
				...
				else if(is_user_logged_in() && !empty($starto_menu_show_client))
				{
			...
			?>
						...
						<div class="menu-cart-wrapper">
						    ...
						    <a class="tooltip" href="<?php echo esc_url($cart_url); ?>" title="<?php esc_attr_e('View Cart', 'starto' ); ?>"><span class="ti-shopping-cart"></span></a>
						</div>
						<?php
						}
						?>

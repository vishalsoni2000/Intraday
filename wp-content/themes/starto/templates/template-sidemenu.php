...
<div class="mobile-menu-wrapper">
	<?php
		$starto_sidemenu_close = get_theme_mod('starto_sidemenu_close');
		if(!empty($starto_sidemenu_close))
		{
	?>
	...
	<?php
		...
		if($starto_menu_layout == 'leftmenu')
	    {
	    	$page_menu_transparent = 0;
	...
	else
	{
        ...
        $starto_retina_transparent_logo = get_theme_mod('starto_retina_transparent_logo');
...
<?php
	...
	starto_set_page_menu_transparent($page_menu_transparent);
?>
<!-- End mobile menu -->
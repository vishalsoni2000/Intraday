<?php
    $starto_blog_display_related = get_theme_mod('starto_blog_display_related', true);
    
    if($starto_blog_display_related)
    {
?>
...
if ($tags) {
 ...
 ?>
	...
	<h3><?php echo esc_html_e('Related Articles', 'starto' ); ?></h3><br class="clear"/>
    <?php
       ...
       $image_thumb = '';
		...
		if(has_post_thumbnail(get_the_ID(), 'starto-gallery-list'))
		{
		    $image_id = get_post_thumbnail_id(get_the_ID());
		    $image_thumb = wp_get_attachment_image_src($image_id, 'starto-gallery-list');
		}
    ?>

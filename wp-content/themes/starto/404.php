...
<div id="page-content-wrapper">
    ...
    <div class="inner">
    	...
    	<div class="inner-wrapper">
	    	...
	    	<h1><?php esc_html_e('Oops! This page can\'t befound anywhere.', 'starto' ); ?></h1>
    	
	    	<div class="search-form-wrapper">
		    	<?php esc_html_e( "We're sorry, the page you have looked for does not exist in our content! Perhaps you would like to go to our homepage or try searching below.", 'starto' ); ?>
		    	<br/><br/>

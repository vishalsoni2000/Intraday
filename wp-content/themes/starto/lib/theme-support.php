...
if ( function_exists( 'add_image_size' ) ) { 
	...
	add_image_size( 'starto-video-grid', 700, 393, true );
	...
	add_image_size( 'starto-gallery-grid', intval($pp_gallery_grid_image_width), intval($pp_gallery_grid_image_height), $image_crop );
	...
	add_image_size( 'starto-gallery-masonry', intval($pp_gallery_masonry_image_width), intval($pp_gallery_masonry_image_height), $image_crop );
	...
	add_image_size( 'starto-gallery-list', intval($pp_gallery_list_image_width), intval($pp_gallery_list_image_height), $image_crop );

	add_image_size( 'starto-album-grid', 660, 740, true );
	...
	add_image_size( 'starto-blog', intval($pp_blog_image_width), intval($pp_blog_image_height), $image_crop );
	...
	add_image_size( 'starto-blog-grid', intval($pp_blog_grid_image_width), intval($pp_blog_grid_image_height), $image_crop );
}

add_action( 'after_setup_theme', 'starto_woocommerce_support' );

function starto_woocommerce_support() {

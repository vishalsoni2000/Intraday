...
add_action( 'tgmpa_register', 'starto_require_plugins' );
 
function starto_require_plugins() {
    ...
    $plugins = array(
	    ...
	    array(
	        'name'               => 'Starto Theme Elements for Elementor',
	        'slug'      		 => 'starto-elementor',
	        'source'             => get_template_directory() . '/lib/plugins/starto-elementor.zip',
	        'required'           => true, 
	        'version'            => '1.5',
	    ),
	    array(
	...
	$config = array(
        ...
        'strings'          => array(
	        'page_title'                      => esc_html__('Install Required Plugins', 'starto' ),
	        'menu_title'                      => esc_html__('Install Plugins', 'starto' ),
	        'installing'                      => esc_html__('Installing Plugin: %s', 'starto' ),
	        'oops'                            => esc_html__('Something went wrong with the plugin API.', 'starto' ),
	        'return'                          => esc_html__('Return to Required Plugins Installer', 'starto' ),
	        'plugin_activated'                => esc_html__('Plugin activated successfully.', 'starto' ),
	        'complete'                        => esc_html__('All plugins installed and activated successfully. %s', 'starto' ),
	        'nag_type'                        => 'update-nag'
	    )
    );
